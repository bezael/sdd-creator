...
| [dominicode-harness-init](./dominicode-harness-init/SKILL.md) | Sets up the CBRM lane: audits real verification commands and generates an `AGENTS.md` with Contract, Lane and Verdict sections. |
